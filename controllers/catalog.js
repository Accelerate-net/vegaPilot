...
app.controller('catalogController', function($scope, $http, $cookies, $timeout) {
    ...
    $scope.dummyCatalog = [
        {
            ...
            displayImage: 'assets/img/expert-coach.png',
            taxDetails: '[\n {\n \"type\": \"TAX\",\n \"mode\": \"PERCENTAGE\",\n \"code\": \"GST\",\n \"label\": \"Total GST\",\n \"value\": \"1800\"\n },\n {\n \"type\": \"EXTRA\",\n \"mode\": \"PERCENTAGE\",\n \"code\": \"PLATFORM\",\n \"label\": \"Platform Fee\",\n \"value\": \"500\"\n }\n]',
            ...
            brief: 'Year-long Course Commencing later in July. Kerala\'s first exclusive IAT coaching with personalized attention and comprehensive preparation.',
            isDiscountApplicable: 0,
            specialPrice: null,
            badgeType: 'admission',
        ...
        },
        {
            ...
            sellingPrice: 99900,
            displayImage: 'assets/img/mock-test.png',
            taxDetails: null,
            ...
            brief: 'The most REALISTIC IISER MOCK TESTS designed by IISER STUDENTS. Practice with exam-like questions and improve your performance.',
        ...
        },
        {
            ...
            originalPrice: 199900,
            sellingPrice: 19900,
            displayImage: 'assets/img/pyq.png',
            taxDetails: null,
            ...
            brief: 'Attempt actual IISER questions, get real-time scores and see which IISER you\'d have got that year. Comprehensive PYQ collection.',
            isDiscountApplicable: 1,
            specialPrice: 19900,
            badgeType: 'official',
            createdBy: '66599dd1-c984-4cd0-944d-72b3a1492552',
        ...
        },
        {
            ...
            sellingPrice: 499000,
            displayImage: 'assets/img/crash-course.png',
            taxDetails: '[\n {\n \"type\": \"TAX\",\n \"mode\": \"PERCENTAGE\",\n \"code\": \"GST\",\n \"label\": \"Total GST\",\n \"value\": \"1800\"\n },\n {\n \"type\": \"EXTRA\",\n \"mode\": \"PERCENTAGE\",\n \"code\": \"PLATFORM\",\n \"label\": \"Platform Fee\",\n \"value\": \"500\"\n }\n]',
            ...
            brief: 'Dream IISER - IAT 2025 Crash Course. Intensive preparation with expert guidance, mock tests, and personalized study plans.',
            isDiscountApplicable: 0,
            specialPrice: null,
            badgeType: 'admission',
            createdBy: '66599dd1-c984-4cd0-944d-72b3a1492552',
        ...
        },
        {
            ...
            displayImage: 'assets/img/online-course.png',
            taxDetails: null,
            otherDetails: '{\n    \"commencement\": \"Immediate\",\n    \"conclusion\": \"31 December 2026\",\n    \"duration\": \"6 Months\",\n    \"mode\": \"Online + Offline\"\n}',
            title: 'IAT 2026 - Hybrid Learning Program',
            subtitle: 'Online + Offline Mode',
            brief: 'Flexible learning with both online and offline sessions. Access to recorded lectures, live doubt sessions, and study materials.',
            isDiscountApplicable: 1,
            specialPrice: null,
            badgeType: 'offer',
            createdBy: '66599dd1-c984-4cd0-944d-72b3a1492552',
        ...
        },
        {
            ...
            sellingPrice: 149900,
            displayImage: 'assets/img/advanced-test.png',
            taxDetails: null,
            ...
            brief: 'Advanced level mock tests designed by IIT/IISER professors. Includes detailed solutions and performance analytics.',
            isDiscountApplicable: 1,
            specialPrice: null,
            badgeType: 'official',
            createdBy: '66599dd1-c984-4cd0-944d-72b3a1492552',
    ...
    $scope.saveCatalog = function() {
        if (!$scope.newCatalog.title || !$scope.newCatalog.code) {
            $scope.showToaster('Please fill in title and code fields.', 'error');
            return;
        }
        ...
        if ($scope.isEditing) {
            ...
            if (index !== -1) {
                $scope.catalog[index] = angular.copy($scope.newCatalog);
                $scope.catalog[index].lastUpdatedOn = Math.floor(Date.now() / 1000);
                
                $scope.showToaster('Catalog item updated successfully!', 'success');
            }
        } else {
            // Create new catalog
            var newItem = angular.copy($scope.newCatalog);
            newItem.id = Math.max(...$scope.catalog.map(c => c.id)) + 1;
            ...
            $scope.showToaster('Catalog item created successfully!', 'success');
        }
