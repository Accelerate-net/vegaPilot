...
export const PERMS = {
  ...
  CLASS_NOTES_VIEW: 'classNotes.view',
  CLASS_NOTES_EDIT: 'classNotes.edit',
  ...
  MENTOR_SESSIONS_VIEW: 'mentorSessions.view',
  MENTOR_SESSIONS_EDIT: 'mentorSessions.edit',
  MENTOR_SESSIONS_HOST: 'mentorSessions.host',
  MENTOR_SESSIONS_DELETE: 'mentorSessions.delete',
...
export const PERMISSION_META = {
  ...
  highRisk: new Set([
    ...
    PERMS.MENTORS_DELETE, PERMS.MENTOR_SESSIONS_DELETE, PERMS.INSTRUCTORS_DELETE, PERMS.RESIDENCES_DISABLE,
    PERMS.ORDERS_REFUND, PERMS.ORDERS_CREATE, PERMS.PAYMENTS_RECORD, PERMS.LEADS_EXPORT, PERMS.BROADCAST_SEND,
